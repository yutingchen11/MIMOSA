...
def get_parser():
    ...
    parser.add_argument('--data_opt', type=str, default='_MIMOSA_7T_R4_lam0p5_echoloss',
                    help='type of dataset')
    parser.add_argument('--data_dir', type=str, default='/data',
                    help='data directory')                
    parser.add_argument('--nrow_GLOB', type=int, default=310,
    ...
    parser.add_argument('--necho_GLOB', type=int, default=7,
    ...
    parser.add_argument('--TL_path', type=str, default='/pretrained_models/ZS_SSL_1101_7T_R4_lam0p5_echoloss_Rate1_2reps_unroll6res5CG6/',
