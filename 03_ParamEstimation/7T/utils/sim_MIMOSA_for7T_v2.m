function [Mz_mtx, Mxy_mtx] = sim_qalas_4acq_pd_b1_T2_outc_mge_t2s_IE_d1__v1_TE60p4(TR, alpha_deg, esp, turbo_factor, t1_vals, t2_vals, num_reps, echo2use, TR_mte,esp_mte,TEs, t2s_vals, gap_between_readouts, time2relax_at_the_end, b1, inv_eff,pd_map )
%
...
TE_flash = 2.9e-3;% for 7T


% timings are based on: https://jcmr-online.biomedcentral.com/track/pdf/10.1186/s12968-014-0102-0.pdf

delay_pre_t2prep = 40e-3 - 0.4e-3; % to control TE of T2 prep, TE=60ms

% BB: hack
delT_M1_M2 = 109.7e-3 - delay_pre_t2prep;                % duration of T2 prep
...
Mxy_mtx = zeross([7, num_voxels, num_reps]);
